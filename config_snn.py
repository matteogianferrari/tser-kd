...
parser.add_argument('--group_name', default='student', type=str, help='Experiment group.')
...
parser.add_argument('--model_path', default='data/student_models/best_acc.pth', type=str, help='Path to save the best model weights.')
